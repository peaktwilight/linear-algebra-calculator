...
def main():
    ...
    st.sidebar.markdown("<div title='The person reading this will ace their next math test'><a href='https://github.com/peaktwilight/linear-algebra-calculator'>GitHub</a> v1.6.2 | FHNW Linear Algebra Module</div>", unsafe_allow_html=True)
